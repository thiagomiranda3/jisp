...
public class Value {
    ...
    public BigDecimal getAsNumber() {
        if (type != TypeValue.Number) {
            throw new IllegalArgumentException(this + " is not a " + TypeValue.Number.name());
        }
    ...
    public String getAsString() {
        if (type != TypeValue.String) {
            throw new IllegalArgumentException(this + " is not a " + TypeValue.String.name());
        }
    ...
    public Boolean getAsBoolean() {
        if (type != TypeValue.Boolean) {
            throw new IllegalArgumentException(this + " is not a " + TypeValue.Boolean.name());
        }
